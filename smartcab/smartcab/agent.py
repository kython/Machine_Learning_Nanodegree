...
class LearningAgent(Agent):
    ...
    def learn(self, state, action, reward):
        ...
        # Update Q-value
        # self.Q[state][action] += self.alpha*(reward + self.gamma*self.get_maxQ(next_state) - self.Q[state][action])
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=EPSILON, alpha=LEARNING_RATE)
    ...
    sim.run(n_test=TEST_NUM, tolerance=TOLERANCE)
